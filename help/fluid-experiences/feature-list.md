...
AEM Fluid Experience は、ヘッドレス配信のユースケースにのみ対処するという点で、従来の AEM とは異なります。 ヘッドフル型コンテンツのオーサリングおよび配信と、AEMのハイブリッド型ユースケースに対する強力なサポートは、AEM Sites、Assets、Dynamic Mediaの各ソリューションでご利用いただけます。
...
* [ヘッドレス CMS向けの柔軟なエクスペリエンス](https://experienceleague.adobe.com/docs/experience-manager-gems-events/gems/gems2017/aem-headless-usecases.html?lang=ja)
* [AEM Content Service：概要、理由、方法](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/content-services/overview.html?lang=ja)
* [サードパーティアクセスに関するFAQ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/content-services/chapter-7.html?lang=ja)
* [Sling APIの使用](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/project-archetype/component-basics.html?lang=ja#sling-models)
