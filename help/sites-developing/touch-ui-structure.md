...
エディターフレームは、すべての&#x200B;*ページオーサリング要素*&#x200B;のコンテナ（抽象）です。 それはコンテンツフレームの上にあり、次のものが含まれます。
...
サイドパネルは、デフォルトでは非表示です。 選択すると、左側に表示されるか、ウィンドウ全体を覆うようにスライドします（ウィンドウサイズが1024 pxの幅より小さい場合、例えばモバイルデバイスで）。

![chlimage_1-150](assets/chlimage_1-150.png)

### サイドパネル - アセット {#side-panel-assets}

「Assets」タブで、アセットの範囲から選択できます。 特定の用語をフィルタリングしたり、グループを選択したりすることもできます。
...
「コンポーネント」タブでは、様々なコンポーネントから選択できます。 特定の用語をフィルタリングしたり、グループを選択したりすることもできます。
