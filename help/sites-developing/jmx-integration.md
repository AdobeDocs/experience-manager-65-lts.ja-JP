...
**メモ：**&#x200B;執筆時点では、Maven の scr プラグインは Eclipse の m2e プラグインと互換性がありません （[Felixのバグ 3170](https://issues.apache.org/jira/browse/FELIX-3170)を参照）。 Eclipse IDEを使用するには、Mavenをインストールし、コマンドラインインターフェイスを使用してビルドを実行します。
