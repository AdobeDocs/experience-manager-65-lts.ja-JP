---
title: Adobe Developer App Builderを使用した  [!DNL Adobe Experience Manager] 6.5 LTS の拡張。
description: Adobe Developer App Builderを使用した  [!DNL Adobe Experience Manager] 6.5 LTS の拡張。
