...
1. 変数のオプションの説明を指定し、ボックス内のチェックマークで示される![保存アイコンを選択します。](assets/Done_Icon.png) 変更を保存します。 変数は、左側のペインで使用可能なリストに表示されます。
...
1. **変数を設定** ステップをワークフローエディターにドラッグ&amp;ドロップし、ステップを選択して、レンチで示される![設定アイコンを選択します。](assets/configure_icon.png) （設定）。
...
1. より多くの変数をマッピングして、有意義な式を作成できるようにします。 ボックス内のチェックマークで示されている![保存アイコンを選択します。](assets/Done_Icon.png) 変更を保存します。
...
移動ステップ、OR‧分岐ステップ、およびすべての‧AEM‧Forms‧Workflow‧ステップでは、変数をサポートしています。
...
OR‧分岐ステップと同様に、ルール定義、ECMA スクリプト、または外部スクリプトを使用して、移動ステップのルーティング式を定義できます。
...
1. 鉛筆シンボルで示される![編集アイコンを選択します。](assets/edit.png) 編集する変数名の横にある（編集）アイコン。
1. 変数情報を編集し、チェックマークが表示されている![保存アイコンを選択します。](assets/Done_Icon.png) 変更を保存します。 変数の「**[!UICONTROL 名前]**」フィールドと「**[!UICONTROL タイプ]**」フィールドは編集できません。
