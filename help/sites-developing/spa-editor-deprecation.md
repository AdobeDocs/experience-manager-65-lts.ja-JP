...
Adobeは、[GA リリース AEM 6.5 LTS、](/help/release-notes/release-notes.md#deprecated-and-removed-features)を使用してSPA エディターを非推奨にしました。つまり、SDKにこれ以上の機能強化や更新は行われません。 アドビでは、AEM の最新のイノベーションの活用に、新しいヘッドレスプロジェクトに対しては[ユニバーサルエディター](/help/sites-developing/universal-editor/introduction.md)を使用することをお勧めします。
