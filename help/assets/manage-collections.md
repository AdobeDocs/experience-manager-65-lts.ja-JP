...
コレクションは、[静的参照](#creating-a-collection-with-static-references)を使用するか、[検索条件ベースのフィルター](#creating-a-smart-collection)に基づいて作成できます。 ライトボックスからコレクションを作成することもできます。
...
1. **[!UICONTROL 保存済み検索]** リストから、変更するスマートコレクションを選択します。 検索パネルには、保存された検索用に設定されたフィルターが表示されます。
...
>* [コレクション用レビュータスクを作成](bulk-approval.md)
