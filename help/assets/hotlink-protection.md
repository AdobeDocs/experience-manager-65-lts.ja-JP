...
[Experience Manager カスタマーサポート](https://experienceleague.adobe.com/ja?support-solution=Experience+Manager&lang=ja#support)では、コンテンツ配信ネットワーク（CDN）レベルでリファラーフィルターを設定することができます。これにより、ドメインに許可された web サイトにのみ Dynamic Media コンテンツが提供されるようになります。
