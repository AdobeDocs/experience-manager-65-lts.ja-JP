...
1. 「**[!UICONTROL アクション]**」タブで次のいずれかの操作を行います。
   ...
   * 「**[!UICONTROL クイックビュー]**」を選択します。
      ...
      * Experience Manager Sitesのユーザーである場合は、製品ピッカーアイコン（虫眼鏡）を選択して、製品を選択ページを開きます。 使用する製品を選択してから、ページの右上隅のチェックマークを選択して、カルーセルバナーエディターに戻ります。
      * Experience Manager Sitesのお客様でない場合
