...
タグをメタデータとして使用することで、アセットを簡単に検索し、検索結果を使用してコレクションを作成し、一部のアセットの検索ランキングを向上させ、Adobe AIのAI アルゴリズムをアセットの検索に使用することができます。

[!DNL Adobe Experience Manager Assets] では、自己学習アルゴリズムを使用して、非常にわかりやすいタグが作成されるので、ユーザーは数回クリックするだけで適切なアセットを見つけることができます。 スマートタグで使用されるAdobe AIは、AdobeのAIとマシンラーニングのフレームワークであり、一般的なタグと企業固有のタグの両方を認識して画像に適用するようにトレーニングすることができます。 スマートタグでは、コンテンツ、個々の単語またはフレーズを識別して、わかりやすいタグをアセットに自動的に適用することもできます。
