...
| [!UICONTROL GenericAssetHandler] | com.day.cq.dam.core.impl.handler.GenericAssetHandler | アセットからデータを抽出するハンドラーが他に見つからなかった場合のフォールバック |
...
* ImageMagick （`https://www.imagemagick.org/script/index.php` web サイト）と[Ghostscript](https://www.ghostscript.com/)を使用したEPSとAIの変換。
...
1. [!DNL ImageMagick]をインストール：`https://www.imagemagick.org/script/download.php` web サイトのImageMagick ドキュメントを参照してください。
