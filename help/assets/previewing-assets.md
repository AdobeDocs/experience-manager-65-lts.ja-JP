...
1. クリックしたアセットの種類に応じて、次のいずれかの操作を行います。
   ...
   <table>
    <tbody>
      ...
      </ul> <p>「<strong>+</strong>」アイコンと「<strong>-</strong>」アイコンを使用して、選択した画像を拡大したり縮小したりします。 画像を元のズームに戻す場合は、<strong> リセット </strong>を選択します。<br /> タッチスクリーンを使用している場合は、画像をダブルクリックしてズームインします。 最大ズームに達したら、画像を再度ダブルクリックして、ズーム状態をリセットします。 画像全体をドラッグするように動かすと、パンします。</p> </td>
      </tr>
      <tr>
      <td>マルチメディア</td>
      <td>はい</td>
      ...
      </ul> <p>「<strong>+</strong>」および「<strong>-</strong>」アイコンを使用して、選択した画像のズームをそれぞれ増減します。 画像を元のズームに戻す場合は、<strong> リセット </strong>を選択します。<br /> タッチスクリーンを使用している場合は、画像をダブルクリックしてズームインします。 最大ズームに達したら、画像を再度ダブルクリックして、ズーム状態をリセットします。 画像全体をドラッグするように動かすと、パンします。</p> </td>
      </tr>
    </tbody>
    </table>
