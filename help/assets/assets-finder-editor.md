...
こうしたアセット中心のアプリケーションは、イントラネット上のシンプルなフォトギャラリーを通じて、展示会への参加や、公開されているweb サイトのプレスセンターから写真をアップロードできます。 また、アセット中心のアプリケーションは、ショッピングカート、チェックアウト、検証プロセスなど、包括的なソリューションにも及ぶことができます。
