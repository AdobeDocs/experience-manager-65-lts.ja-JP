...
1. お使いのオペレーティングシステムに適したImageMagick インストールファイル （`https://www.imagemagick.org/script/download.php` web サイト）をダウンロードします。
...
さらに、さまざまな画像処理プラグインは、PHPのimagick、Rubyのrmagickとpaperclip、nodejsのimagemagickなど、ImageMagick ライブラリに依存しています。
