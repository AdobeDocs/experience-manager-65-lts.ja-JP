---
title: ライブコピーの作成と同期
description: Adobe Experience Manager でライブコピーを作成および同期する方法について説明します。
...
1. ソースページを選択し、「**次へ**」をクリックします。例：

   ![ソースページを選択](assets/chlimage_1-213.png)

1. （ライブコピーの親フォルダーまたはページを開いて）ライブコピーの宛先のパスを指定し、「**次へ**」をクリックします。
...
1. 「**作成**」をクリックします。確認メッセージが表示されます。ここで「**開く**」または「**完了**」のいずれかを選択できます。
...
1. ページとサブページを指定し、チェックマークを付けて確定します。
   ...
   ![ページとサブページを指定](assets/chlimage_1-221.png)
...
ライブコピーページがソースページに同期されている場合、追加されたコンポーネントは変更されずに維持されます。詳しくは、[ライブコピーページ上のコンポーネントの順序の変更](#changing-the-order-of-components-on-a-live-copy-page)も参照してください。
...
1. 次のいずれかから適切なオプションを選択します。
   ...
   * **子ページも休止**
   ...
   ![適切な休止オプションを選択](assets/chlimage_1-226.png)
...
1. 継承をキャンセルするコンポーネントをクリックします。
   ...
   ![継承をキャンセルするコンポーネントを選択アクション](assets/chlimage_1-230.png)
...
1. プロパティの継承をキャンセルするには、プロパティの右側に表示されるリンクアイコンをクリックします。

   ![プロパティの継承をキャンセル](do-not-localize/chlimage_1-10.png)

1. **継承をキャンセル**&#x200B;確認ダイアログで、「**はい**」をクリックします。
...
1. **ライブコピーをリセット**&#x200B;ダイアログで&#x200B;**リセット**&#x200B;アクションを確定します。
   ...
   ![リセットを確定](assets/chlimage_1-234.png)

## ライブコピーページとブループリントページの比較 {#comparing-a-live-copy-page-with-a-blueprint-page}

加えた変更を追跡するには、**参照**&#x200B;でブループリントページを確認し、ライブコピーページと比較します。

1. **Sites** コンソールで、[ブループリントページまたはライブコピーページに移動し、ページを選択します](/help/sites-authoring/basic-handling.md#viewing-and-selecting-resources)。
...
* **ライブコピーのサブページの分離**
  ...
  *ただし*、サブページは引き続き親ブランチのライブ関係の対象であり、ブループリントページの今後のロールアウトでは、次のように処理されます。
   ...
   1. ロールアウトからの変更を含む（ライブコピー）ページが元の名前で作成されます。
