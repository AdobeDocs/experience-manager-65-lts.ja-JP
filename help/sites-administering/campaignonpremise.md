...
>[!INFO]
>
>このドキュメントでは、Adobe Campaign ClassicをAEM 6.5と統合する方法について詳しく説明します。 Campaignのその他の統合機能については、[AEM 6.5とAdobe Campaignの統合](campaign.md)を参照してください。
...
1. 設定を編集するための新しいウィンドウとダイアログが開きます。 必要な情報を入力します。
   ...
   * **ユーザー名** – これは[前の手順で作成されたAdobe Campaign AEM統合パッケージオペレーターです。](#create-operator) デフォルトでは `aemserver` です。
