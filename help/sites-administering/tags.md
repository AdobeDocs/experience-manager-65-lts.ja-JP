...
タグは、名前空間にグループ化し、新しいタグを作成する前に既存のタグの使用を確認し、現在参照されているコンテンツからタグを切り離さずに再整理することによって管理されます。
...
名前空間または他のタグが選択されているときに&#x200B;**結合**&#x200B;アイコンを選択すると、パネルが開き、結合先のパスを選択できます。
...
>
>参照先のタグが移動または結合されても、タグは物理的には削除されないので、参照を維持することは可能です。
