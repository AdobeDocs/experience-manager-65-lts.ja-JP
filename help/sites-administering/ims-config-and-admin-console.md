...
ユーザー同期を設定するには、[[!DNL User Management] API](https://adobe-apiplatform.github.io/user-sync.py/en/success-guide/identify_server.html) を使用する場合と同様に、お客様の組織で一連の資格情報を作成する必要があります。
