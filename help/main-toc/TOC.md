...
+ Sites {#sites}
  ...
  + 管理 {#administering}
    ...
    + ベストプラクティス {#bestpractices}
      ...
      + [AEM Foundation に対する GDPR 要求の処理](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/security/handling-gdpr-requests-for-aem-platform.html?lang=ja)
...
+ Forms {#forms}
  ...
  + AEM Forms の管理 {#manage-administer-aem-forms}
    ...
    + ユーザーデータの処理 {#handling-user-data}
      + {hide-from-toc}[OSGiのForms中心のワークフロー](/help/forms/using/forms-workflow-osgi-handling-user-data.md)
  ...
  + JEE 上の AEM Forms の管理者ヘルプ {#administrator-help}
    ...
    + コンテンツ管理システムへの接続 {#connect-content-management-system}
      + {hide-from-toc}[EMC Documentum®用コネクタの設定](/help/forms/using/admin-help/configuring-connector-emc-documentum.md)
      + {hide-from-toc}[IBM® FileNet用コネクタの設定](/help/forms/using/admin-help/configuring-connector-ibm-filenet.md)
      + {hide-from-toc}[IBM® Content Manager用コネクタの設定](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
    ...
    + Acrobat Reader DC Extensionsの設定 {#configure-acrobat-reader-dc-extensions}
      + {hide-from-toc}[Acrobat Reader DC Extensionsで使用される証明書の種類](/help/forms/using/admin-help/certificate-types-used-acrobat-reader.md)
    ...
    + SSL の設定 {#configure-ssl}
      ...
      + {hide-from-toc}[WebSphere® Application Server用のSSLの設定](/help/forms/using/admin-help/configuring-ssl-websphere-application-server.md)
    ...
    + アプリケーションサーバーの管理 {#manage-application-server}
      ...
      + {hide-from-toc}[WebSphere® Application Serverの開始と停止](/help/forms/using/admin-help/starting-stopping-websphere-application-server.md)
  ...
  + プロセスレポート {#process-reporting}
    ...
    + {hide-from-toc}[プロセスレポートの カスタムレポート &#x200B;](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
    + {hide-from-toc}[プロセスレポートの アドホッククエリ &#x200B;](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md)
  ...
  + 開発者向けリファレンス {#developer-reference}
    ...
    + JEE 上の AEM Forms でのプログラミング {#programming-aem-forms-jee}
      ...
      + API を使用した JEE 上の AEM Forms の呼び出し {#invoking-aem-forms-jee-apis}
        ...
        + {hide-from-toc}[Remotingを使用したAEM Formsの呼び出し](/help/forms/developing/invoking-aem-forms-using-remoting.md)
  ...
  + トラブルシューティング {#troubleshooting}
    ...
    + {hide-from-toc}[Windows ServerでWordまたはExcel ファイルをPDFに変換できません](/help/forms/using/disable-uac-for-pdfgconfiguration.md)
...
+ 実装 {#implementing}
  + 開発 {#developing}
    ...
    + ヘッドレスエクスペリエンス管理 {#headless}
      ...
      + ヘッドレスジャーニー {#journeys}
        + ヘッドレスデベロッパージャーニー {#developer}
          + [AEM のヘッドレスを理解する](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/overview.html?lang=ja)
          ...
          + [AEM ヘッドレス機能を使用した初めてのエクスペリエンスまでの手順](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/path-to-first-experience.html?lang=ja)
          ...
          + [アプリとコンテンツをすべて AEM ヘッドレスにまとめる方法](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/put-it-all-together.html?lang=ja)
          + [ヘッドレスアプリケーションの運用開始方法](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/go-live.html?lang=ja)
        ...
        + ヘッドレスコンテンツ設計者ジャーニー {#architect}
          + [AEM ヘッドレスコンテンツ設計者ジャーニーの概要](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/overview.html?lang=ja)
          + [AEM でのヘッドレス向けコンテンツモデリング入門](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/introduction.html?lang=ja)
          + [AEM でのヘッドレス向けコンテンツモデリングの基本について](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/basics.html?lang=ja)
          + [AEM でのコンテンツフラグメントモデルの作成について](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/model-structure.html?lang=ja)
      ...
      + コンテンツフラグメント{#content-fragments}
        ...
        + [お使いのインスタンスでコンテンツフラグメント機能を有効にする](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-configuration-browser.html?lang=ja)
        ...
        + [マークダウン](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-markdown.html?lang=ja)
        ...
        + [プレビュー - JSON 表現形式](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-json-preview.html?lang=ja)
      + 配信 API{#delivery-api}
        ...
        + [コンテンツフラグメントを使用したAEM GraphQL API - サンプルコンテンツとクエリ](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/content-fragments-graphql-samples.html?lang=ja)
    ...
    + ベストプラクティス {#bestpractices}
      ...
      + [AEMの開発ガイドラインとベストプラクティス](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/introduction/dev-guidelines-bestpractices.html?lang=ja)
  ...
  + デプロイ {#deploying}
    ...
    + AEM 6.5 LTSへのアップグレード {#upgrading}
      ...
      + {hide-from-toc}[AEM 6.5 LTSの下位互換性](/help/sites-deploying/backward-compatibility.md)
