...
* **ブランド**
Adobe Experience Manager （AEM）では、ブランドは最上位のユニットであり、**キャンペーン**&#x200B;のコレクションを形成します。

* **件のキャンペーン**
キャンペーンは、個々の**エクスペリエンス**&#x200B;のコレクションです。

* **件のエクスペリエンス**
焦点を絞ったコンテンツは、様々なエクスペリエンスを形成し、**顧客接点**&#x200B;で訪問者に提示します。 以下のような様々なタイプのエクスペリエンスが使用できます。
