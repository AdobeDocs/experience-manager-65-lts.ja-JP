...
[原則1：知覚可能 – 情報とユーザーインターフェイスのコンポーネントは、ユーザーが認識できる方法で提示する必要があります。](https://www.w3.org/TR/WCAG20/#perceivable)

### 代替テキスト（1.1） {#text-alternatives}

[ガイドライン 1.1 テキストの代替案：テキスト以外のコンテンツに対するテキストの代替案を提供し、大きな印刷物、点字、音声、記号、シンプルな言語など、人々が必要とする他の形式に変更できるようにします。](https://www.w3.org/TR/WCAG20/#text-equiv)
...
Web ページの情報は、画像、ビデオ、アニメーション、グラフなど、テキスト以外の様々な形式で提供できます。 目が見えない人や視覚障害が重い人は、テキストコンテンツ以外のコンテンツを見ることができませんが、スクリーンリーダーで読み上げたり、点字ディスプレイで触覚的な形で表示したりすることで、テキストコンテンツにアクセスできます。 したがって、グラフィカルな形式のコンテンツに代替テキストを提供すれば、そのコンテンツを見ることのできないユーザーであっても、コンテンツが提供する同等のバージョンの情報にアクセスできます。
...
* [成功基準1.1.1](https://www.w3.org/TR/UNDERSTANDING-WCAG20/text-equiv-all.html)
* [達成基準1.1.1の達成方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#text-alternatives)
* [W3C：便利な代替テキストを提供するためのHTML5のテクニック](https://html.spec.whatwg.org/multipage/images.html#alt)
* [CAPTCHAのW3C説明と代替案](https://www.w3.org/TR/turingtest/)

### 時間依存メディア（1.2） {#time-based-media}

[ガイドライン 1.2時間ベースのメディア：時間ベースのメディアの代替手段を提供する。](https://www.w3.org/TR/WCAG20/#text-equiv)
...
* [成功基準1.2.1](https://www.w3.org/TR/UNDERSTANDING-WCAG20/media-equiv-av-only-alt.html)
* [達成基準1.2.1の達成方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#time-based-media)
...
* [達成基準1.2.2を満たす方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#time-based-media)
* [W3C：同期マルチメディア](https://www.w3.org/AudioVideo/)
* [キャプション、トランスクリプト、およびオーディオの説明 – WebAIMによる](https://webaim.org/techniques/captions/)
...
* [達成基準1.2.3を満たす方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-media-equiv-audio-desc)
...
* [成功基準1.2.4について](https://www.w3.org/TR/UNDERSTANDING-WCAG20/media-equiv-real-time-captions.html)
* [達成基準1.2.4を満たす方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-media-equiv-real-time-captions)
...
* [成功基準1.2.5について](https://www.w3.org/TR/UNDERSTANDING-WCAG20/media-equiv-audio-desc-only.html)
* [達成基準1.2.5を満たす方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-media-equiv-audio-desc-only)

### 適応可能 (1.3) {#adaptable}

[ガイドライン 1.3適応可能：情報や構造を失うことなく、様々な方法（よりシンプルなレイアウトなど）で表示できるコンテンツを作成します。](https://www.w3.org/TR/WCAG20/#content-structure-separation)
...
* **強調テキスト**：
  ...
  &lt;strong>または&lt;em> element to indicate emphasis. を使用段落内のテキストをハイライト表示するために見出しを使用しないでください。
...
* **複雑なデータテーブル：**
  ...
  レベルが 2 つ以上あるヘッダーを含む複雑なテーブルがある場合など、場合によっては、基本的なテーブルのプロパティでは必要な構造情報を十分に指定できないことがあります。 このような複雑なテーブルの場合は、**header** 属性と **id** 属性を使用して、ヘッダーと関連セルとの間に直接の関係を作成する必要があります。 例えば、以下に示すテーブルでは、支援テクノロジーユーザーのためのプログラムによる関連付けを作成するために、ヘッダーと id が照合されています。
...
* [成功基準1.3.1](https://www.w3.org/TR/UNDERSTANDING-WCAG20/content-structure-separation-programmatic.html)
* [達成基準1.3.1の達成方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-content-structure-separation-programmatic)
...
* [成功基準1.3.3について](https://www.w3.org/TR/UNDERSTANDING-WCAG20/content-structure-separation-understanding.html)
* [達成基準1.3.3の達成方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-content-structure-separation-understanding)

### 判別可能（1.4） {#distinguishable}

[ガイドライン 1.4識別可能：前景と背景を分離する等、ユーザーがコンテンツを見たり聞いたりしやすくします。](https://www.w3.org/TR/WCAG20/#visual-audio-contrast)
...
* [成功基準1.4.1](https://www.w3.org/TR/2008/NOTE-WCAG20-TECHS-20081211/working-examples/G183/link-contrast.html)
* [達成基準1.4.1の達成方法](https://www.w3.org/TR/2008/NOTE-WCAG20-TECHS-20081211/working-examples/G183/link-contrast.html)
* [「web セーフカラー」のリストを含む、3:1のコントラスト比を満たすためのガイダンス](https://www.w3.org/TR/2008/NOTE-WCAG20-TECHS-20081211/working-examples/G183/link-contrast.html)
...
* [成功基準1.4.3](https://www.w3.org/TR/UNDERSTANDING-WCAG20/visual-audio-contrast-contrast.html)
* [達成基準1.4.3の達成方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-visual-audio-contrast-contrast)
...
* [成功基準1.4.5について](https://www.w3.org/TR/UNDERSTANDING-WCAG20/visual-audio-contrast-text-presentation.html)
* [達成基準1.4.5の達成方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-visual-audio-contrast-text-presentation)

## 原則 2：操作可能 {#principle-operable}

[原則2：操作可能 – ユーザーインターフェイスコンポーネントとナビゲーションは操作可能である必要があります。](https://www.w3.org/TR/WCAG20/#operable)
...
* 適切なテクノロジーを使用して、ブラウザーで無効化できる点滅コンテンツを表示します。 例えば、Graphics Interchange Format（GIF）ファイルや Animated Portable Network Graphics（APNG）ファイルなどです。
...
* [達成基準2.2.2について](https://www.w3.org/TR/UNDERSTANDING-WCAG20/time-limits-pause.html)
* [達成基準2.2.2を満たす方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-time-limits-pause)

### 発作の防止（2.3） {#seizures}

[ガイドライン 2.3発作：発作を引き起こすことが知られている方法でコンテンツを設計しないでください。](https://www.w3.org/TR/WCAG20/#seizure)
...
* [達成基準2.3.1](https://www.w3.org/TR/UNDERSTANDING-WCAG20/seizure-does-not-violate.html)
* [達成基準2.3.1を満たす方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#seizure)
...
* [達成基準2.4.2](https://www.w3.org/TR/UNDERSTANDING-WCAG20/navigation-mechanisms-title.html)
* [達成基準2.4.2の達成方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-navigation-mechanisms-title)
...
* [達成基準2.4.4](https://www.w3.org/TR/UNDERSTANDING-WCAG20/navigation-mechanisms-refs.html)
* [達成基準2.4.4を満たす方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-navigation-mechanisms-refs)
* [C7:CSSを使用してリンクテキストの一部を非表示にする](https://www.w3.org/TR/2008/NOTE-WCAG20-TECHS-20081211/C7)

## 原則 3：理解可能 {#principle-understandable}

[原則3：理解可能 – 情報とユーザーインターフェイスの操作は理解可能でなければなりません。](https://www.w3.org/TR/WCAG20/#understandable)

### テキストコンテンツを読みやすく理解可能にする（3.1） {#make-text-content-readable-and-understandable}

[ガイドライン 3.1読みやすくする：テキストコンテンツを読みやすくし、理解しやすくします。](https://www.w3.org/TR/WCAG20/#meaning)
...
* [達成基準3.1.1](https://www.w3.org/TR/UNDERSTANDING-WCAG20/meaning-doc-lang-id.html)
* [達成基準3.1.1の達成方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-meaning-doc-lang-id)
...
* [達成基準3.1.2](https://www.w3.org/TR/UNDERSTANDING-WCAG20/meaning-other-lang-id.html)
* [達成基準3.1.2の達成方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-meaning-other-lang-id)

### ユーザーによるミスの回避と修正の支援（3.3） {#help-users-avoid-and-correct-mistakes}

[ガイダンス 3.3入力支援：利用者がミスを避け、修正できるようにします。](https://www.w3.org/TR/WCAG20/#minimize-error)
...
一部のフォームコンポーネントでは、「**タイトルを非表示**」チェックボックスを使用して、ラベルを視覚的に非表示にすることもできます。 このように非表示になっているラベルは、支援テクノロジーでは引き続き利用できますが、画面には表示されません。 状況によってはこの方法が適していることもありますが、通常は可能な限り視覚的なラベルを含めることをお勧めします。 これは、一部のユーザーが画面の非常に小さな部分（一度に 1 つのフィールド）を表示し、フィールドを正しく識別するためのラベルが必要となる場合があるためです。
...
* [達成基準3.3.2](https://www.w3.org/TR/UNDERSTANDING-WCAG20/minimize-error-cues.html)
* [達成基準3.3.2を満たす方法](https://www.w3.org/WAI/WCAG21/quickref/?versions=2.0#qr-minimize-error-cues)
