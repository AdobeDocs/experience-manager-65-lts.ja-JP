...
[クイックスタート（SOAP モード）：Java™ API を使用して PDF ドキュメントを PostScript に変換](convert-pdf-service-java-api.md#quick-start-soap-mode-converting-a-pdf-document-to-postscript-using-the-java-api)

[クイックスタート（SOAP モード）：Java™ API を使用して PDF ドキュメントを JPEG ファイルに変換](convert-pdf-service-java-api.md#quick-start-soap-mode-converting-a-pdf-document-to-jpeg-files-using-the-java-api)
