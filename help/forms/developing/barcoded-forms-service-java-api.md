---
title: Barcoded Forms Service Java&trade; API クイックスタート（SOAP）
description: AEM FormsのBarcoded Forms Service Java&trade; API クイックスタート（SOAP）を使用して、バーコードをシームレスに処理する方法について説明します。
contentOwner: admin
