...
1. 必要に応じて、区切り記号として「改行」を選択し、「条件を追加」を選択してルールを作成します。テキストを区切り記号として使用し、区切り記号として使用するテキスト文字を指定することもできます。
...
1. 条件またはルールを保存して、繰り返し構造を保存します。条件が設定された繰り返し構造が、選択したコンテンツに適用されます。
   ...
   テキストドキュメントフラグメントにポインタを合わせると、コンテンツに適用された繰り返し構造内で使用されている条件と区切り記号が表示されます。
...
1. 動的テキストを書式設定するための区切り記号を選択し、チェックマークを選択して保存します。
