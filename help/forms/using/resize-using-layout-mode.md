...
AEM as a Cloud Serviceのドキュメントについては、[Cloud Service上のAEM Forms](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/configure-layout-of-an-adaptive-form/resize-using-layout-mode.html?lang=ja)を参照してください。
...
1. [アダプティブフォーム](../../forms/using/creating-adaptive-form.md)を作成するか、既存のアダプティブフォームを開きます。
...
1. 「**はい**」を選択して、フォームの&#x200B;**レイアウト**&#x200B;モードを有効にします。
