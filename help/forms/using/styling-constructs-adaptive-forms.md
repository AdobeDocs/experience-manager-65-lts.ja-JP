...
description: LESS フレームワークを使用して、アダプティブフォームの外観をカスタマイズできます。
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>ヘッダー行の背景色 デフォルト値は <code>#333</code> です。<br /> </p> </td>
  </tr>
  <tr>
   <td><p><code>table-odd-row-bg-color</code></p> </td>
   <td><p>奇数のボディ行の背景色 デフォルト値は <code>rgb(255, 255, 255)</code> です。</p> </td>
  </tr>
  <tr>
   <td><p><code>table-even-row-bg-color</code></p> </td>
   <td><p>偶数のボディ行の背景色 デフォルト値は <code>#eee</code> です。</p> </td>
  </tr>
 </tbody>
</table>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>ネストされた／子／サブナビゲーターを持たないタブナビゲーター（左側と上部）</p> </td>
  </tr>
 </tbody>
</table>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>ウィザードナビゲーターの行頭文字（キャプション／ラベルの前に接頭辞として付ける）のボーダーの色</p> </td>
  </tr>
  <tr>
