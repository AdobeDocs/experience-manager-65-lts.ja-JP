...
| 関連付け | データモデルオブジェクト |
|---|---|
| 1:n | 顧客 :calls （月々の請求書で、1 人の顧客と複数の通話を関連付けることができます） |
| 1:1 | 顧客 :bills （特定の月に 1 つの請求書が 1 人の顧客に関連付けられます） |
...
1. 「**完了**」を選択して、顧客と通話データモデルオブジェクト間で 1:n の関連付けを作成します。

   顧客と通話データモデルオブジェクト間で関連付けを作成したら、顧客と通話データモデルオブジェクト間で 1:1 の関連付けを作成します。
