...
* **アセットタイプ**：アセットの種類 有効な値には、**フォーム**、**PDF フォーム**、**印刷フォーム**&#x200B;および&#x200B;**アダプティブフォーム**&#x200B;などがあります。
...
1. カスタムメタデータの場合は、このプロパティを&#x200B;**jcr:content/metadata** ノードにのみ保存します。 他の場所に保存した場合、フォームポータルはメタデータを表示できません。
