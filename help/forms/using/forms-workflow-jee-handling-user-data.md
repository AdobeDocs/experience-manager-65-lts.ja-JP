...
AEM Forms JEE ワークフロープロセスの作成について詳しくは、[ワークベンチヘルプ](https://www.adobe.com/go/learn_aemforms_workbench_65_jp)を参照してください。
...
### ワークフローのイニシエーターまたは参加者が分かっている場合のプロセスインスタンス ID の特定 {#initiator-participant}
