---
title: フォームデータモデルの使用
description: ここでは、フォームデータモデルを使用してアダプティブフォームとインタラクティブなコミュニケーションを作成し、それらを使用する方法について説明します。
...
AEM Forms のデータ統合機能により、各種のバックエンドデータソースを使用してフォームデータモデルを作成できます。作成したデータフォームは、様々なアダプティブフォームとインタラクティブなコミュニケーションのワークフローで、スキーマとして使用できます。 そのためには、データソースの設定を行い、そのデータソース内の有効なデータモデルオブジェクトとデータモデルサービスに基づいて、フォームデータモデルを作成する必要があります。 詳しくは、以下のトピックを参照してください。
...
* [インタラクティブなコミュニケーションと、構築ブロック（テキストフラグメント、リストフラグメント、条件フラグメントなど）を作成する](#create-ic)
* [サンプルデータを使用してインタラクティブなコミュニケーションのプレビューを表示する](#preview-ic)
* [アダプティブフォームとインタラクティブなコミュニケーションに事前にデータを取り込む](#prefill)
...
## インタラクティブなコミュニケーションを作成 {#create-ic}

フォームデータモデルに基づいて、インタラクティブなコミュニケーションを作成できます。フォームデータモデルを使用して、設定済みデータソースのデータをインタラクティブなコミュニケーションに事前に取り込むことができます。 また、フォームデータモデルに基づいて、インタラクティブなコミュニケーションの構築ブロック（テキスト、リストおよび条件のドキュメントフラグメントなど）を作成できます。

インタラクティブなコミュニケーションまたはドキュメントフラグメントを作成する際に、フォームデータモデルを選択できます。 次の図は、インタラクティブなコミュニケーションを作成ダイアログの「一般」タブを示しています。

![create-ic](assets/create-ic.png)

インタラクティブなコミュニケーションを作成ダイアログの「一般」タブ
...
フォームデータモデルエディターでは、フォームデータモデル内のデータモデルオブジェクト用のサンプルデータを生成して編集できます。 このデータを使用すると、インタラクティブなコミュニケーションとアダプティブフォームをプレビューおよびテストできます。 プレビュー表示を行う前に、[フォームデータモデルの操作](../../forms/using/work-with-form-data-model.md#sample)の説明に従って、サンプルデータを生成します。

サンプルのフォームデータモデルのデータを使用してインタラクティブなコミュニケーションをプレビューするには：

1. AEM オーサーインスタンスで、**[!UICONTROL フォーム／フォームとドキュメント]**&#x200B;に移動します。
1. インタラクティブなコミュニケーションを選択してツールバーで「**[!UICONTROL プレビュー]**」を選択し、「**[!UICONTROL Web チャネル]**」、「**[!UICONTROL 印刷チャネル]**」、または「**[!UICONTROL 両方のチャネル]**」を選択します。これにより、選択したインタラクティブなコミュニケーションのプレビューが表示されます。
1. プレビューの&#x200B;[*チャネル*]&#x200B;ダイアログで、「**[!UICONTROL フォームデータモデルのデータのテスト]**」が選択されていることを確認して「**[!UICONTROL プレビュー]**」を選択します。

サンプルデータが取り込まれた状態のインタラクティブなコミュニケーションが表示されます。
...
AEM Forms には、すぐに使用できるフォームデータモデル事前入力サービスが用意されています。フォームデータモデルに基づいて、このサービスをアダプティブフォームおよびインタラクティブなコミュニケーションで使用することができます。 この事前入力サービスは、アダプティブフォームおよびインタラクティブなコミュニケーション内のデータモデルオブジェクトに対してデータソースのクエリを実行し、フォームまたは通信のレンダリング時にデータを事前入力します。
...
インタラクティブなコミュニケーションでフォームデータモデル事前入力サービスを設定するには、インタラクティブなコミュニケーションの作成時に「事前入力サービス」ドロップダウンで「フォームデータモデル事前入力サービス」を選択します。後でプロパティを編集することもできます。

![edit-ic-props](assets/edit-ic-props.png)

インタラクティブなコミュニケーションのプロパティ編集ダイアログ
