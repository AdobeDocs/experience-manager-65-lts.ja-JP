...
AEM as a Cloud Serviceのドキュメントについては、[Cloud Service上のAEM Forms](https://experienceleague.adobe.com/ja/docs/experience-manager-cloud-service/content/forms/integrate/services/embed-adaptive-form-core-components-external-web-page)を参照してください。
...
1. AEM パブリッシュインスタンスで、AEM web コンソール設定マネージャー（`https://'[server]:[port]'/system/console/configMgr`）に移動します。
