...
以下のサンプルコードでは、既に暗号化されている PDF ドキュメント内の署名フィールドを検証するために、DocAssuranceService が使用されています。
...
<table>
 <tbody>
  ...
  <tr>
   <td><code>unlockOptions</code><br /> </td>
   <td>暗号化されたファイルのロックを解除するために必要なパラメーターなどがあります。これは、ファイルが暗号化されている場合にのみ必要です。<br /> </td>
  </tr>
 </tbody>
</table>

以下の Java コードのサンプルを使用することで、署名フィールドからデジタル署名を削除することができます。
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>ドキュメントを開くパスワード、またはドキュメントからセキュリティを削除するために使用する権限パスワード。<br /> </td>
  </tr>
 </tbody>
</table>

以下のコードサンプルを使用することで、パスワードベースの暗号化を PDF ドキュメントから削除することができます。
...
<table>
 <tbody>
  ...
  <tr>
   <td><code>ResourceResolver</code></td>
   <td>ResourceResolver を使用して、特定のユーザーのキーストアにアクセスし、資格情報を取得します。</td>
  </tr>
 </tbody>
</table>
...
インタラクティブ PDF フォームからフォームデータを XML および XDP 形式で書き出します。
...
以下の Java コードのサンプルを使用することで、インタラクティブ PDF フォームからフォームデータを XML および XDP 形式で書き出すことができます。
...
>[!NOTE]
>
>AIX オペレーティングシステムで稼動している AEM Forms サーバーでは、HTMLtoPDF API の使用は非推奨です。
...
以下の Java コードを使用することで、対応するファイルタイプのドキュメントを PDF ドキュメントに変換することができます。
...
### ドキュメントユーティリティサービス {#doc-utility-services}
