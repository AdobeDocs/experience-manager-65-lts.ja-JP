---
title: レターとインタラクティブなコミュニケーションの後処理
...
# レターとインタラクティブなコミュニケーションの後処理{#post-processing-of-letters-and-interactive-communications}
...
後処理をレターとインタラクティブなコミュニケーションに関連付けるには、まず後処理を設定する必要があります。 送信済みのレターに対しては、次の 2 つのタイプのワークフローが実行できます。
...
1. 処理／サービスを認証するには、処理の名前をコピーし、Adobe Experience Manager web コンソール設定ページ／AEM Forms Client SDK Configuration に戻ってこのプロセスを新しいサービスとして追加します。
