---
title: チュートリアル：インタラクティブなコミュニケーションの計画
description: インタラクティブなコミュニケーション用の分析の計画
...
インタラクティブなコミュニケーションの計画の第一歩は、インタラクティブなコミュニケーションの内容を確定することです。 法務部門、経理部門、サポート部門、マーケティング部門などのサブジェクトマターエキスパート（SME）は、その内容を確定するのに役に立ちます。 内容が確定したら、内容を分析してインタラクティブなコミュニケーションの作成に必要な各種アセットタイプを特定する必要があります。
...
次のテーブルに、インタラクティブなコミュニケーションの分析内の各フィールドのデータソースを示します。
