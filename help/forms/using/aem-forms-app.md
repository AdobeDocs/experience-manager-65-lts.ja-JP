...
* **以前のバージョンのアプリをAndroidのPlay ストアからインストールした場合**
Play ストアから直接アプリをアップグレードできます。
