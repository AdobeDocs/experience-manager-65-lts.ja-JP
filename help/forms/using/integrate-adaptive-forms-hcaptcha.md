---
title: AEM 6.5 FormsでhCaptcha&reg；を使用する方法
...
<span class="preview">この機能は、機能切り替えID `FT_FORMS-12407`に基づいています。 この機能を有効にするには、[機能の切り替えを有効にする](/help/forms/using/enable-feature-toggle.md)の記事に記載されている手順に従います。</span>
