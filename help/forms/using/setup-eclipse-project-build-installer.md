...
次の画像には、`adobe-lc-mobileworkspace-src-<version>.zip\android` フォルダーの構造が表示されています。
...
* `Path` システム環境変数を、Android の platform-tools フォルダーおよび tools フォルダーに含めるように設定します。 例えば、C:\Users\&lt;username>\AppData\Local\Android\Sdk\platform-toolsおよびC:\Users\&lt;username>\AppData\Local\Android\Sdk\toolsとします。
