---
title: Android&trade; スタジオプロジェクトを設定し、Android&trade; アプリを構築する
description: Android&trade; Studio プロジェクトを設定し、Adobe Experience Manager （AEM） Forms アプリのインストーラーを構築する手順
...
次の画像には、`src`フォルダー内の `android`フォルダーのディレクトリ構造が表示されています。
