...
>[!VIDEO](https://video.tv.adobe.com/v/34097/?captions=jpn&quality=12)

AEM マルチサイト管理のライブコピー機能および言語コピー機能を Commerce Integration Framework と組み合わせて使用すると、地域とロケールをまたいでサイトをグローバルに管理することができます。

AEM サイトとAdobe Commerce ストアビューの間で1:1のリレーションシップを使用することをお勧めします。
...
3. 次の手順に従って、CIF Cloud Service 設定の子設定を作成します。
   ...
   * 上記のポイント 2 で説明した手順を使用して、設定を作成します。
   ...
   >[!TIP]
   >
   >コマースカタログは、ID または UID を使用して対処できます。 UIDは、Adobe Commerce 2.4.2で導入されました。 コマースバックエンドがバージョン 2.4.2以降のGraphQL スキーマをサポートしている場合にのみ、これを有効にします。
...
* [Adobe Commerceのweb サイト、実店舗、閲覧数](https://experienceleague.adobe.com/docs/commerce-admin/start/setup/websites-stores-views.html?lang=ja)
