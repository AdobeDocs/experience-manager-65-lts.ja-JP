...
>[!TIP]
>
>コンテンツの公開をスケジュールすると、コンテンツが複製され、公開ワークフローが適用されます。既に公開済みのコンテンツを非公開にせずに一時的に非表示にする場合は、ページプロパティで&#x200B;[**オンタイム**&#x200B;と&#x200B;**オフタイム**&#x200B;を使用できることを検討してください。](/help/sites-authoring/editing-page-properties.md#on-time)
...
ページを編集する際に、そのページを非公開にする場合、**ページを公開**&#x200B;する際と同じように、**ページ情報**&#x200B;メニューで「[ページを非公開](/help/sites-authoring/publishing-pages.md#publishing-from-the-editor)」を選択します。
