...
<table>
 <tbody>
  <tr>
   ...
   <td>技術的俊敏性、高いパフォーマンスおよび安定したディザスタリカバリ機能について説明したホワイトペーパーを提供しています。</td>
  </tr>
  <tr>
...
AEMには現在、同じリリースのクラシック UIとタッチ操作向けUIの2つのUIがあります。 そのため、顧客は、プロジェクトの実装中にどのツールを使用するかを決定する必要があります。 このドキュメントは、適切な選択肢を見つけるのに役立つことを目的としています。
