...
# アプリケーションサーバーのインストールのアップグレード手順（Tomcat - サイドグレード） {#upgrade-steps-for-application-server-installations-tomcat}

>[!NOTE]
>
>ここでは、Tomcat でのAEM 6.5 からAEM 6.5 LTS へのアップグレード手順の概要を説明します。 AEM 6.5 LTS からAEM 6.5 LTS Servicepack にアップグレードする場合は、[&#x200B; を参照してください &#x200B;](/help/sites-deploying/app-server-upgrade-tomcat-inplace.md)
